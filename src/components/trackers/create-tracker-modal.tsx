...
import { Collection, Tracker, TrackerType, ScanFrequency, SelectorType } from "@/types/database";
...
export default function CreateTrackerModal({ isOpen, onClose, onSuccess }: CreateTrackerModalProps) {
  ...
  const [type, setType] = useState<TrackerType>("website");
  ...
  const resetForm = () => {
    ...
    setTagsString("");
    setSectionSelector("");
    setSectionSelectorType("css");
    setSectionMonitoredElement("");
    setPriceTargetPrice("");
    setPriceCurrency("INR");
    setJobRole("");
    setJobLocation("");
    setJobRemoteOnly(false);
    setJobKeywords("");
    setPdfFileName("");
    setError(null);
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If collectionId was provided, we could increment the collection's trackerCount (optional MVP polish)
      if (collectionId) {
    ...
    <Dialog isOpen={isOpen} onClose={handleClose}>
      <DialogContent className="max-w-[550px] max-h-[90vh] overflow-y-auto" onClose={handleClose}>
        <DialogHeader>
          ...
          <DialogDescription>
            Configure scanner options below to begin automatic change detection.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="text-xs font-bold font-mono tracking-wider uppercase text-foreground-secondary flex items-center gap-1">
                  <Layout className="h-3.5 w-3.5" /> Type
                </label>
                <select
                  value={type}
                ...
                >
                  ...
                  <option value="job">Job Keywords</option>
              ...
              <div className="space-y-4 rounded-2xl border border-border-glass bg-white/[0.01] p-4">
                ...
                <div className="flex items-center gap-2 py-1">
                  <input
                    ...
                    disabled={submitting}
                  />
                  <label htmlFor="remoteOnly" className="text-sm text-foreground-secondary select-none cursor-pointer">
            ...
            <div className="flex items-center gap-2 py-1 select-none">
              <input
                ...
                disabled={submitting}
              />
              <label htmlFor="isPublic" className="text-sm text-foreground-secondary cursor-pointer">
